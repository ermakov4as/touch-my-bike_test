...
export default {
  ...
  get offers() {
    return this._ctx[this._attr]
  },
  set offers(offers) {
    this._ctx[this._attr] = offers
  },
  // create: offer =>
...
function example() {
  return {
    images: [
      {
        id: 1,
        url: 'http://165.22.24.80:8000/media/images/av2s.JPG'
      },
      {
        id: 2,
        url: 'http://165.22.24.80:8000/media/images/ava.jpg'
      }
    ],
    bike: Bike.example(),
    volume: '130',
